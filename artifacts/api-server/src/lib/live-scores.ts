...
async function persistMatch(match: LiveMatch) {
  try {
    ...
    logger.error({ err }, "Failed to persist match");
  }
}
...
export function createMatch(data: Omit<LiveMatch, "id" | "startedAt" | "updatedAt" | "balls" | "wicketsA" | "wicketsB" | "teamAPlayers" | "teamBPlayers" | "bowlers">): LiveMatch {
