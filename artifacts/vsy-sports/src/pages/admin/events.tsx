        ...
        <DialogContent className="max-h-[92vh] overflow-y-auto bg-[#1a1d27] border-white/10 text-white sm:max-w-lg">
          ...
          <div className="space-y-4 pt-1">
            ...
            <div>
              ...
              <Input value={form.title} onChange={set("title")} placeholder={form.type === "tournament" ? "e.g. VSY Summer Championship 2026" : "e.g. Corporate Cricket Night"}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input value={form.venue} onChange={set("venue")} placeholder="VSY Ground" className="bg-white/[0.05] border-white/10 text-white placeholder:text-white/20 h-11" />
              </div>
              <div>
