import { connectDB, User, Turf, TimeSlot, Event, Product } from "@workspace/db";
...
async function seed() {
  ...
  if (turfCount > 0) {
    ...
    const turfsData = [
      {
        ...
        status: "approved", featured: true, ownerId: owner._id,
      },
      {
      ...
      },
      {
        ...
        status: "approved", featured: false, ownerId: owner._id,
      },
      {
    ...
    for (const turfData of turfsData) {
      ...
      for (const slot of slots) {
        await TimeSlot.create({ turfId: turf._id, ...slot });
      }
    }
  ...
  if (productCount > 0) {
    ...
    const products = [
      { name: "SS Ton Reserve Edition Cricket Bat", description: "Premium English Willow Grade 1 bat.", price: 4999, originalPrice: 6500, images: ["https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=400&q=80"], category: "Bats", brand: "SS", stock: 15, rating: 4.8, reviewCount: 234 },
      { name: "MRF Virat Kohli Genius Cricket Bat", description: "Premium Kashmir Willow with MRF grip.", price: 3499, originalPrice: 4200, images: ["https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=400&q=80"], category: "Bats", brand: "MRF", stock: 20, rating: 4.7, reviewCount: 456 },
      { name: "SG Practice Cricket Ball (Pack of 6)", description: "High-quality leather cricket balls for practice.", price: 899, originalPrice: 1200, images: ["https://images.unsplash.com/photo-1529516548873-9ce57c8f155e?w=400&q=80"], category: "Balls", brand: "SG", stock: 50, rating: 4.6, reviewCount: 312 },
      { name: "Kookaburra Pace Cricket Ball", description: "Professional match-quality ball.", price: 599, images: ["https://images.unsplash.com/photo-1551958219-acbc630e2914?w=400&q=80"], category: "Balls", brand: "Kookaburra", stock: 60, rating: 4.5, reviewCount: 189 },
      { name: "Shrey Pro Guard Cricket Helmet", description: "ABS outer shell with adjustable titanium grille.", price: 2799, originalPrice: 3500, images: ["https://images.unsplash.com/photo-1578320339912-f6ce1a14de5e?w=400&q=80"], category: "Helmets", brand: "Shrey", stock: 12, rating: 4.9, reviewCount: 145 },
      { name: "DSP Cricket Batting Gloves", description: "Premium leather palm gloves with high-density foam protection.", price: 1299, originalPrice: 1800, images: ["https://images.unsplash.com/photo-1614632537197-38a17061c2bd?w=400&q=80"], category: "Gloves", brand: "DSP", stock: 30, rating: 4.5, reviewCount: 98 },
      { name: "SS Batting Leg Guards (Pads)", description: "Lightweight batting pads with superior protection.", price: 1899, originalPrice: 2400, images: ["https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=400&q=80"], category: "Pads", brand: "SS", stock: 18, rating: 4.4, reviewCount: 67 },
      { name: "Puma Cricket Kit Bag - Large", description: "Spacious kit bag with dedicated bat pockets.", price: 2499, originalPrice: 3200, images: ["https://images.unsplash.com/photo-1622396481328-9b1b78cdd9fd?w=400&q=80"], category: "Bags", brand: "Puma", stock: 10, rating: 4.6, reviewCount: 78 },
      { name: "Nike Dri-FIT Cricket Jersey", description: "Official-look cricket jersey with Dri-FIT technology.", price: 1199, originalPrice: 1499, images: ["https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&q=80"], category: "Apparel", brand: "Nike", stock: 40, rating: 4.3, reviewCount: 156 },
      { name: "Adidas Cricket Shoes - Spike", description: "Professional cricket shoes with rubber spikes.", price: 3299, originalPrice: 4000, images: ["https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&q=80"], category: "Apparel", brand: "Adidas", stock: 8, rating: 4.7, reviewCount: 89 },
      { name: "Wicket Keeping Gloves - Pro Series", description: "Professional keeping gloves with cushioned palm.", price: 1599, originalPrice: 2000, images: ["https://images.unsplash.com/photo-1614632537197-38a17061c2bd?w=400&q=80"], category: "Gloves", brand: "GM", stock: 14, rating: 4.5, reviewCount: 43 },
      { name: "Cricket Training Ball - Leather (Pack of 3)", description: "Premium leather training balls with hand-stitched seam.", price: 449, originalPrice: 600, images: ["https://images.unsplash.com/photo-1489944440615-453fc2b6a9a9?w=400&q=80"], category: "Balls", brand: "SG", stock: 75, rating: 4.4, reviewCount: 267 },
    ];
